...
/**
 ...
 Edited 2020 by Konrad Mihelsson konrad.mihelsson@gmail.com
...
public class HttpParser {
    private static final String[][] HTTP_REPLIES = {{"100", "Continue"},
    ...
    public int parseRequest() throws IOException {
        ...
        if (cmd[0].equals("GET") || cmd[0].equals("HEAD")) {
            ...
            if (idx < 0) {
                ...
                url = URLDecoder.decode(cmd[1].substring(0, idx), StandardCharsets.ISO_8859_1);
                ...
                for (i = 0; i < prms.length; i++) {
                    ...
                    if (temp.length == 2) {
                        ...
                        params.put(URLDecoder.decode(temp[0], StandardCharsets.ISO_8859_1),
    ...
    public static String getHttpReply(int codevalue) {
        ...
        ret = null;
        key = "" + codevalue;
        for (i = 0; i < HTTP_REPLIES.length; i++) {
            if (HTTP_REPLIES[i][0].equals(key)) {
                ret = codevalue + " " + HTTP_REPLIES[i][1];
                break;
            }
        }
